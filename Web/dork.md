...
örnekler :
HASSAS BİLGİ VEREN GÜVENLİK AÇIKLARI İÇİN DORKING ÖRNEKLERİ:
...
-----------------------------------------------------------------------------
PHP YÖNLENDİRME (URL REDIRECT) GÜVENLİK AÇIĞI OLANLAR İÇİN DORKING ÖRNEKLERİ:
